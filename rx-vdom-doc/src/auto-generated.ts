...
export const setup = {
    ...
    installMainModule: ({cdnClient, installParameters}:{
        ...
        return cdnClient.install({
            ...
            return window[`@youwol/rx-vdom-doc_APIv01`]
        })
    },
    installAuxiliaryModule: ({name, cdnClient, installParameters}:{
        ...
        const scripts = [
            ...(parameters.scripts || []),
            `@youwol/rx-vdom-doc#0.1.0-wip~dist/@youwol/rx-vdom-doc/${entry.name}.js`
        ]
        const modules = [
            ...(parameters.modules || []),
        ...
        return cdnClient.install({
            ...
            return window[`@youwol/rx-vdom-doc/${entry.name}_APIv01`]
        })
    },
