...
const externals = {
    ...
    '@youwol/mkdocs-ts/src/lib':
        "window['@youwol/mkdocs-ts_APIv04']['src']['lib']",
    '@youwol/mkdocs-ts/src/lib/code-api/models':
        "window['@youwol/mkdocs-ts_APIv04']['src']['lib']['code-api']['models']",
...
const entries = {
    ...
    ...Object.values(secondaryEntries).reduce(
        (acc, e) => ({
            ...acc,
            [`@youwol/rx-vdom-doc/${e.name}`]: e.entryFile,
        }),
        {},
    ),
}
export const setup = {
    ...
    developerDocumentation:
        'https://platform.youwol.com/applications/@youwol/cdn-explorer/latest?package=@youwol/rx-vdom-doc&tab=doc',
    ...
    installAuxiliaryModule: ({
        ...
        const scripts = [
            ...(parameters.scripts || []),
            `@youwol/rx-vdom-doc#1.0.2-wip~dist/@youwol/rx-vdom-doc/${entry.name}.js`,
        ]
        const modules = [
            ...(parameters.modules || []),
